...
#		feature_comps.impute_sample_values() 
#		sys.exit() 
#		feature_comps.predict_sample_values() 

#		sys.exit() 
 
		feature_comps.predict_missing_sample_values() 


		for t in feature_comps.expected_totals: 
			print t

		sys.exit() 


		t_srt = [[t[1]/float(t[0]),t[1],t[0],t[2]] for t in feature_comps.expected_totals]
